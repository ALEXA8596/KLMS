                ...
                lesson ? (
                    <div className="flex flex-row justify-start bg-blue-200 rounded-lg p-4 mx-56">
                        <div className="w-full">
                            ...
                            <p className="text-sm text-gray-500 mb-4">Posted by {lesson.creatorName}</p>
                            <p className="mb-4"><Markdown>{lesson.content}</Markdown></p>
                            <ShareBar post={lesson}></ShareBar>
                            {userData && lesson && userData.id === lesson.creatorId && (
                                <a href={`/lesson/${lessonId}/edit`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-4 inline-block">
